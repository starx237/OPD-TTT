...
# Use device_count() instead of is_available() to work around PyTorch 2.6.0+cu124
# driver version check that incorrectly returns False for valid CUDA 12.4 setups
IS_CUDA_AVAILABLE = torch.cuda.device_count() > 0
