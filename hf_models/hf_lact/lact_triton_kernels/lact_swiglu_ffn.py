...
# Import with fallback for different module contexts
try:
    # Try absolute import first
    from hf_models.hf_lact.lact_triton_kernels.triton_swiglu_bwd_kernels import (
        swiglu_backward_three_bmm_triton,
        swiglu_backward_three_bmm_triton_op,
    )
    from hf_models.hf_lact.lact_triton_kernels.triton_swiglu_kernels import fused_two_mm_swiglu_triton
except ImportError:
    try:
        # Try relative import
        ...
        # Try direct import from current package
        from triton_swiglu_bwd_kernels import (
            swiglu_backward_three_bmm_triton,
            swiglu_backward_three_bmm_triton_op,
        )
